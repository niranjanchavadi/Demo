...
public class StateCensusAnalyser {
    ...
    public String getStateWiseSortedStateCode() throws StateCensusAnalyserException {
        if (censusDAOMap == null || censusDAOMap.size() == 0)
            throw new StateCensusAnalyserException("No State Data", StateCensusAnalyserException.ExceptionType.UNABLE_TO_PARSE);
    ...
    public String getStateWiseSortedSPopulation() throws StateCensusAnalyserException {
        if (censusDAOMap == null || censusDAOMap.size() == 0)
            throw new StateCensusAnalyserException("No Population State Data", StateCensusAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM);
    ...
    //METHOD TO SORT STATE ON Density OF POPULATION
    public String getStateWiseSortedSPopulationDensity() throws StateCensusAnalyserException {
        if (censusDAOMap == null || censusDAOMap.size() == 0)
            throw new StateCensusAnalyserException("No DensityPerSquareKM State Data", StateCensusAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM);
    ...
    public String getStateWiseSortedStateArea() throws StateCensusAnalyserException {
        if (censusDAOMap == null || censusDAOMap.size() == 0)
            throw new StateCensusAnalyserException("No Area of State Data", StateCensusAnalyserException.ExceptionType.UNABLE_TO_PARSE);
