...
public class StateCensusAnalyserTest {
    ...
    public static  final String INDIA_STATE_CENSUS_CSV_FILE_PATH = "D:\\Generics\\src\\main\\resources\\StateCensusData.csv";
    public static  final String INDIA_STATE_CODE_CSV_FILE_PATH = "D:\\Generics\\src\\main\\resources\\StateCode.csv";;
    StateCensusAnalyser censusAnalyser = new StateCensusAnalyser();
        ...
        public void givenIndianStateCodeData_WhenSortedOnState_ShouldReturnSortedList() {
            try {
                ...
                Assert.assertEquals("AN", stateCensuses[0].stateCode);
            } catch (CSVBuilderException e) {
                e.printStackTrace();
            } catch (StateCensusAnalyserException e) {
                e.printStackTrace();
    ...
    public void givenIndianStateCensusData_WhenSortedOnDensityPerSquareKM_ShouldReturnSortedList_2() {
        try {
            ...
            String sortedCensusData = censusAnalyser.getStateWiseSortedSPopulationDensity();
            CensusDAO[] stateCensuses = new Gson().fromJson(sortedCensusData, CensusDAO[].class);
            Assert.assertEquals("Meghalaya", stateCensuses[28].state);
        } catch (CSVBuilderException e) {
            e.printStackTrace();
        } catch (StateCensusAnalyserException e) {
            e.printStackTrace();
